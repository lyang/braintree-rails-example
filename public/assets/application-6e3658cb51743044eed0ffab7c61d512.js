...
(function() {
  jQuery(function() {
    ...
    $('#address_country_code_alpha2').change(function() {
      ...
      if (options) {
        ...
        return $('#address_region').parent().parent().show();
      } else {
        $('#address_region').empty();
        return $('#address_region').parent().parent().hide();
      }
    });
    return $('#address_country_code_alpha2').change();
  });
...
(function() {
  jQuery(function() {
    ...
    return $('#transaction_billing_country_code_alpha2').change(function() {
      var country, escaped_country, options;
      ...
      if (options) {
        ...
        return $('#transaction_billing_region').parent().parent().show();
      } else {
        $('#transaction_billing_region').empty();
        return $('#transaction_billing_region').parent().parent().hide();
      }
    });
  });
